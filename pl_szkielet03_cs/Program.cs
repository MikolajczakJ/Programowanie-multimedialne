...
namespace PMLabs
{
    ...
    class Program
    {
        ...
        public static void InitOpenGLProgram(Window window)
        {
            ...
            sp = new ShaderProgram("v_simplest.glsl", "f_simplest.glsl"); //Wczytaj przykładowy program cieniujący
        ...
        public static void DrawScene(Window window,float angle_x,float angle_y)
        {
            ...
            GL.VertexAttribPointer(sp.A("vertex"), 4, VertexAttribPointerType.Float, false, 0, MyCube.vertices); //Dane do atrybutu vertex pobieraj z tablicy MyCube.vertices

            GL.DrawArrays(PrimitiveType.Triangles, 0, MyCube.vertexCount); //Rysuj model
