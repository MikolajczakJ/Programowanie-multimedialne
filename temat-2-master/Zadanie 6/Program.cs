...
namespace PMLabs
{
    ...
    class Program
    {
        ...
        public static void DrawScene(Window window, float angle_x, float angle_y)
        {
            ...
            GL.VertexAttribPointer(DemoShaders.spTextured.A("vertex"), 4, VertexAttribPointerType.Float, false, 0, MyTeapot.vertices);
            GL.VertexAttribPointer(DemoShaders.spTextured.A("texCoord"), 2, VertexAttribPointerType.Float, false, 0, MyTeapot.texCoords);
